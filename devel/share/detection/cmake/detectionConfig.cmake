...
if("TRUE" STREQUAL "TRUE")
  set(detection_SOURCE_PREFIX /home/nvidia/ros_rosbot_ws/src/detection)
  set(detection_DEVEL_PREFIX /home/nvidia/ros_rosbot_ws/devel)
  ...
  set(detection_INSTALL_PREFIX /home/nvidia/ros_rosbot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/ros_rosbot_ws/src/detection/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/ros_rosbot_ws/devel/lib;/home/nvidia/ros_mmdeploy_ws/devel/lib;/home/nvidia/realsense_ros_ws/devel/lib;/home/nvidia/tf_0/devel/lib;/home/nvidia/tf/devel/lib;/opt/ros/melodic/lib)
